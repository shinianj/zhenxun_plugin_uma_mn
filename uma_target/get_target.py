...
async def get_tar(uma_name, is_force):
    if not os.path.exists(os.path.join(os.path.dirname(__file__), f'uma_target/')):
        os.mkdir(os.path.join(os.path.dirname(__file__), f'uma_target/'))
    img_path = os.path.join(os.path.dirname(__file__), f'uma_target/target_{uma_name}.png')
